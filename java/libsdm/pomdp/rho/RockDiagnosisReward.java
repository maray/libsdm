...
public class RockDiagnosisReward implements BeliefReward {
	...
	public RockDiagnosisReward(int type,int rocks_configs,int states,int actions) {
		this(type,rocks_configs,states,actions,0);
	}
	
	public RockDiagnosisReward(int type,int rocks_configs,int states,int actions, int horizon) {
