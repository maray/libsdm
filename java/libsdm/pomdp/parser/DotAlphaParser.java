...
public class DotAlphaParser extends Parser {
    ...
    // delegators
        ...
        public DotAlphaParser(TokenStream input, RecognizerSharedState state) {
            super(input, state);
             
        }
        

    public String[] getTokenNames() { return DotAlphaParser.tokenNames; }
    ...
    // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:86:1: dotAlpha : ( action_decl alpha_vector )+ ;
    public final void dotAlpha() throws RecognitionException {
        ...
        try {
            // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:87:5: ( ( action_decl alpha_vector )+ )
            // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:88:9: ( action_decl alpha_vector )+
            {
            // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:88:9: ( action_decl alpha_vector )+
            int cnt1=0;
            loop1:
            do {
                ...
                switch (alt1) {
            	case 1 :
            	    // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:89:13: action_decl alpha_vector
            	    {
    ...
    // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:103:1: action_decl returns [int a] : INT ;
    public final int action_decl() throws RecognitionException {
        ...
        try {
            // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:104:5: ( INT )
            // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:104:9: INT
            {
            INT3=(Token)match(input,INT,FOLLOW_INT_in_action_decl368); 
            a = Integer.parseInt((INT3!=null?INT3.getText():null));
    ...
    // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:108:1: alpha_vector returns [ArrayList<Double> v = new ArrayList<Double>()] : ( optional_sign FLOAT )+ ;
    public final ArrayList<Double> alpha_vector() throws RecognitionException {
        ...
        try {
            // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:109:5: ( ( optional_sign FLOAT )+ )
            // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:109:9: ( optional_sign FLOAT )+
            {
            // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:109:9: ( optional_sign FLOAT )+
            int cnt2=0;
            loop2:
            do {
                ...
                switch (alt2) {
            	case 1 :
            	    // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:109:10: optional_sign FLOAT
            	    {
            	    ...
            	    FLOAT5=(Token)match(input,FLOAT,FOLLOW_FLOAT_in_alpha_vector404); 

            	                v.add(optional_sign4 * Double.parseDouble((FLOAT5!=null?FLOAT5.getText():null)));
    ...
    // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:117:1: optional_sign returns [int s] : ( '+' | '-' | );
    public final int optional_sign() throws RecognitionException {
        int s = 0;

        try {
            // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:118:5: ( '+' | '-' | )
            int alt3=3;
            switch ( input.LA(1) ) {
            case 8:
                {
            ...
            switch (alt3) {
                case 1 :
                    // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:118:7: '+'
                    {
                    ...
                    break;
                case 2 :
                    // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:120:7: '-'
                    {
                    ...
                    break;
                case 3 :
                    // /home/mauricio/scm/libsdm/java/libsdm/pomdp/parser/DotAlpha.g:123:9: 
                    {
                    s = 1;
